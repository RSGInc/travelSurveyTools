...
If we want to summarize a multiple response variable, we can set `summarize_vartype` to checkbox.
...
hh_size_list = hts_prep_variable(summarize_var = 'hh_size',
                                 variables_dt = variable_list,
                                 data = test_data)

hh_size_summary = hts_summary(prepped_dt = hh_size_list$cat, 
