...
two_way_race_summary = hts_summary(hts_data = test_data,
            variables_dt = variable_list,
            values_dt = value_labels,
            summarize_var = 'mode_type',
            summarize_by = 'race')

head(two_way_race_summary$cat_summary$wtd, 20)

```

```{r, mode_type_ethnicity_example, echo=TRUE, eval=TRUE}

two_way_ethnicity_summary = hts_summary(hts_data = test_data,
            variables_dt = variable_list,
            values_dt = value_labels,
            summarize_var = 'mode_type',
            summarize_by = 'ethnicity')

head(two_way_ethnicity_summary$cat_summary$wtd, 20)
